...
|---|---|---|---|---|
| **A: 間接プロンプトインジェクション** | T1 | 間接プロンプトインジェクション | Playbook 2 | メモリポイズニングとコンテキスト操作の防止 |
| | T6 | 意図破壊とゴール操作 | Playbook 1 | 推論操作と意思決定の完全性 |
| **B: エコノミック DoS** | T4 | 過剰エージェンシー / リソース消費 | Playbook 3 | ツール実行とリソースの完全性 |
| **C: メモリポイズニング** | T3 | メモリポイズニング | Playbook 3 | ツール実行とリソースの完全性 |
| | T8 | 永続コンテキスト操作 | Playbook 1 | 推論操作と意思決定の完全性 |
...
| **ダッシュボード メモリスキャン** | 長期記憶に注入された攻撃キーワードや異常価格 | T1、T3 | Playbook 2 | メモリポイズニングとコンテキスト操作の防止 |
